    ...
    <group {...props} dispose={null}>
      ...
      <group position={[0, 0.203, -0.878]} rotation={[-1.391, 0.228, -2.973]} scale={0.104}>
        <group rotation={[Math.PI / 2, 0, 0]} scale={0.01}>
          <group position={[93.437, 97.903, 18.617]} rotation={[-Math.PI / 2, 0, 0]} scale={319.199}>
      ...
      <mesh rotation={[-Math.PI / 2, 0, 0]} position={[-1.403, -1.08, -1.038]} scale={4.14}>
      ...
      <group position={[-0.231, -0.941, -0.731]} rotation={[0, -0.434, 0]}>
        ...
        <group position={[0.066, -0.044, -0.16]} rotation={[0, 0, -Math.PI / 2]} scale={0.017}>
          <mesh
            castShadow
            receiveShadow
      ...
      />
      <Html position={[0, 1, 0]}>
        <button onClick={moveCamera}>Enter Site</button>
      </Html>
    </group>
  )
}
